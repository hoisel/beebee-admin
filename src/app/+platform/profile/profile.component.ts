...
import { isValidEmail, DATE_MASK, CELL_PHONE_MASK, STATES, AuthService, UsersService, User } from '../../core'
...
export class ProfileComponent implements OnInit {
  ...
  private fillForm (): void {
    this.usersService.get( this.auth.user.id ).subscribe(( user: User ) => {
      this.form.setValue( this.pick( this.auth.user, [ 'id', 'name', 'cpf', 'rg', 'email', 'cellphone', 'phone', 'driverLicence', 'driverLicenceExpiration' ] ) )
   ...
   * @memberOf ProfileComponent
   */
  private pick ( obj: any, props: string[] ): any {
